...
class SaveOpenEXR:
    ...
    def INPUT_TYPES(s):
        ...
        return {
            "required": {
                "images" : ("Image",),
                "filename_prefix" : ("STRING", {"default": "Grit"}),
                "data_format":(
                    ["16-bit HALF",
                     "32-bit FLOAT"],
                ...
                "subfolders" : (sorted(subfolders), {"default": ""}),
                "initial_index": ("STRING", {"default": "####"}),
    ...
    FUNCTION = "write_exr"
    OUTPUT_NODE = True
    CATEGORY    = "Comfyui OpenEXR"

    def write_exr(self, images, filename_prefix, data_format, compression, subfolders, initial_index, frame_padding):
        # Your implementation here
        pass


NODE_CLASS_MAPPINGS = {
    "LoadOpenEXR": LoadOpenEXR,
    "SaveOpenEXR": SaveOpenEXR,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "LoadOpenEXR": "Load OpenEXR",
    "SaveOpenEXR": "Save OpenEXR",
}